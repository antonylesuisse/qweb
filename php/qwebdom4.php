...
/*
 Nécessite PHP5, utilise l'extension DOM (activée par défaut)
  et éventuellement l'extension PHP5/XSL (fournie) pour les fonctions domxml_xslt
...
class php4DOMNode
{
 ...
 function node_name() {return ($this->myDOMNode->nodeType==XML_ELEMENT_NODE) ? $this->myDOMNode->localName : $this->myDOMNode->nodeName;} //Évite préfixe espace de nom
